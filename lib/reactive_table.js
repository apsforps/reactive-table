...
var generateSettings =  function () {
    var group = this.settings.group || 'reactive-table';
    ...
    Session.setDefault(getSessionShowNavigationKey(group), settings.showNavigation);
...
UI.registerHelper('reactiveTable', function () {
  return Template['reactiveTable'];
});
